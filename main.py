...
class weatherRoot(BoxLayout):
	...
	def add_locationButton_event(self):
		self.clear_widgets()
...
class AddLocationForm(BoxLayout):
	...
	def search_location(self):
		search_template="http://api.openweathermap.org/data/2.5/find?q={}&APPID=df52d1a0bdd200685c48e512e7dfdb5d"
	...
	def found_location(self,request,data):
		...
		self.search_results.adapter.data.extend(self.search_results.item_strings)
